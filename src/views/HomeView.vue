...
<template>
  <main class="text-center">
    ...
    >
      Lorem ipsum dolor sit amet consectetur adipisicing elit. In natus, nisi,
      dolores quasi cupiditate accusantium inventore voluptatum iure vel cumque
      nihil debitis culpa sint incidunt consequatur illum ratione. Possimus,
      iste!
    </p>
    <a
      href="#"
